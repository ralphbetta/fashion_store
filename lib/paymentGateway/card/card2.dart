          ...
          child: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                //
                _getPlatformButton(
                    'UI Local Card Charge', () => _uILocalCharge()),
                _verticalSizeBox,
                _getPlatformButton(
                    'Server Pop Card Charge', () => _serverPopCharge()),
                /*------------------------------------------
                Radio botton switcher.
                ---------------------------------------------*/
                Row(
                          ...
                          : Column(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    /*------------------------------------------
                                    Dropdown For custom Bank or card payment
                                    ---------------------------------------------*/
                                    Flexible(
                                      flex: 3,
